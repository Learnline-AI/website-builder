...
// ============================================
// THEMEABLE BUTTON (uses CSS variables)
// ============================================
...
/**
 * ThemedButton - Uses CSS variable tokens for theming
 * This button automatically adapts to the current theme via CSS variables
 */
...
// Themed button registry entries
const themedButtonEntries: ElementEntry[] = [
  {
    id: 'btn-themed-primary',
    name: 'Themed Primary Button',
    layer: 'molecule',
    category: 'buttons',
    description: 'Primary button that adapts to current theme via CSS variables',
    themeAgnostic: true,
    composedOf: ['color-primary', 'radius-button', 'shadow-button'],
    sourceComponents: ['token-system'],
    extractedFrom: 'src/elements/molecules/buttons/index.tsx',
    previewType: 'inline',
    hasInteraction: true,
    implementation: 'component',
    component: ThemedButton as React.FC<ButtonProps>,
    codeSnippet: `<ThemedButton variant="primary">Click me</ThemedButton>`,
    tags: ['button', 'themed', 'css-variables', 'primary', 'interactive'],
  },
  {
    id: 'btn-themed-secondary',
    name: 'Themed Secondary Button',
    layer: 'molecule',
    category: 'buttons',
    description: 'Secondary button that adapts to current theme',
    themeAgnostic: true,
    composedOf: ['color-secondary', 'radius-button'],
    sourceComponents: ['token-system'],
    extractedFrom: 'src/elements/molecules/buttons/index.tsx',
    previewType: 'inline',
    hasInteraction: true,
    implementation: 'component',
    component: (props: ButtonProps) => <ThemedButton {...props} variant="secondary" />,
    codeSnippet: `<ThemedButton variant="secondary">Click me</ThemedButton>`,
    tags: ['button', 'themed', 'css-variables', 'secondary', 'interactive'],
  },
  {
    id: 'btn-themed-outline',
    name: 'Themed Outline Button',
    layer: 'molecule',
    category: 'buttons',
    description: 'Outline button that adapts to current theme',
    themeAgnostic: true,
    composedOf: ['color-primary', 'border-thick', 'radius-button'],
    sourceComponents: ['token-system'],
    extractedFrom: 'src/elements/molecules/buttons/index.tsx',
    previewType: 'inline',
    hasInteraction: true,
    implementation: 'component',
    component: (props: ButtonProps) => <ThemedButton {...props} variant="outline" />,
    codeSnippet: `<ThemedButton variant="outline">Click me</ThemedButton>`,
    tags: ['button', 'themed', 'css-variables', 'outline', 'interactive'],
  },
  {
    id: 'btn-themed-ghost',
    name: 'Themed Ghost Button',
    layer: 'molecule',
    category: 'buttons',
    description: 'Ghost button that adapts to current theme',
    themeAgnostic: true,
    composedOf: ['color-text', 'radius-button'],
    sourceComponents: ['token-system'],
    extractedFrom: 'src/elements/molecules/buttons/index.tsx',
    previewType: 'inline',
    hasInteraction: true,
    implementation: 'component',
    component: (props: ButtonProps) => <ThemedButton {...props} variant="ghost" />,
    codeSnippet: `<ThemedButton variant="ghost">Click me</ThemedButton>`,
    tags: ['button', 'themed', 'css-variables', 'ghost', 'interactive'],
  },
];

export const buttonRegistry: ElementEntry[] = [
  // Themed buttons (CSS variable-based, theme-responsive)
  ...themedButtonEntries,

  // Primary variants (legacy, hardcoded colors)
